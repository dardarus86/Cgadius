...
Menu::Menu(sf::RenderWindow* hwnd, Input* in, GameState *state)
{
	...
	text3.setFont(font);
	text3.setString("sounds using numpad. 0 -shot1, 1 - shot2, 2 - shot 3, 3 - death, \n 4 - enemydeath, 5 - explosion, 6 - Bossdeath, 7 - bosshit 8, - warning \n User controls - arrow keys to move, numpad 0 to fire");
